...
class PeopleSearchModel {
  ...
  factory PeopleSearchModel.fromJson(Map<String, dynamic> json) =>
      PeopleSearchModel(
        ...
        data: List<PeopleDatum>.from(
            json["data"].map((x) => PeopleDatum.fromJson(x))),
      );
...
class PeopleDatum {
  ...
  factory PeopleDatum.fromJson(Map<String, dynamic> json) => PeopleDatum(
        malId: json["mal_id"],
        url: json["url"],
