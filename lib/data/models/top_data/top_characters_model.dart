...
TopCharactersModel topCharactersModelFromJson(String str) =>
    TopCharactersModel.fromJson(json.decode(str));

String topCharactersModelToJson(TopCharactersModel data) =>
    json.encode(data.toJson());

class TopCharactersModel {
  ...
  factory TopCharactersModel.fromJson(Map<String, dynamic> json) =>
      TopCharactersModel(
